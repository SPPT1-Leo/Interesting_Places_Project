    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('uf_id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('codigo_ibge') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($cidade->nome) ?></td>
                <td><?= $cidade->has('uf') ? $this->Html->link($cidade->uf->id, ['controller' => 'Uf', 'action' => 'view', $cidade->uf->id]) : '' ?></td>
                <td><?= $this->Number->format($cidade->codigo_ibge) ?></td>
                <td class="actions">
